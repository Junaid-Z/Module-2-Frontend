    ...
    <div className='studentPageContainer'>
      <CustomizedTables rows={data}
        cols={[
          ...
          { displayName: "Duration", value: "duration", data: true },
          { displayName: "Fee", value: "fees", data: true },
      ...
      <BasicModal open={modalData.state}
        ...
        main={<div className='modalButtonHolder'>
          ...
          <Button variant="contained" onClick={() => {
            axios.delete('http://localhost:2121/courses/' + modalData.data._id).catch((e) => { console.log(e) })
            setData((prev) => {
